    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="main-card">
                ...
                <?php
                    // -----------------------------------------------------------
                    // ส่วนที่ 1: ตรวจสอบว่ามีการกดปุ่ม "ส่งใบสมัคร" มาหรือไม่
                    // -----------------------------------------------------------
                    if (isset($_POST['submit_btn'])) {
                        ...
                        // คำนวณอายุ (ลูกเล่นเพิ่มเติม)
                        $birthDate = new DateTime($dob);
                        $today     = new DateTime();
                        $age       = $today->diff($birthDate)->y;
                        $dob_show  = $birthDate->format('d/m/Y'); // แปลงวันที่เป็น วัน/เดือน/ปี
                ?>
                ...
                <?php
                    ...
                    // -----------------------------------------------------------
                    // ส่วนที่ 2: แสดงแบบฟอร์ม (ถ้ายังไม่ได้กดส่ง ให้โชว์ฟอร์มนี้)
                    // -----------------------------------------------------------
                ?>
